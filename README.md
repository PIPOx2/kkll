...
function Update:Window(text,logo,keybind)
	...
	Top.Name = "Top"
	Top.Parent = Main
	Top.BackgroundColor3 = Color3.fromRGB(10, 9, 9)
	Top.Size = UDim2.new(0, 900, 0, 10000)
	...
	Name.Position = UDim2.new(0.209756112, 0, 0, 0)
	...
	Hub.Position = UDim2.new(0, 200, 0, 0)
	...
	BindButton.Position = UDim2.new(0.817561002, 0, 0, 0)
	...
	function uitab:Tab(text,lol)
		...
		IDK.Position = UDim2.new(0, 8, 0,-14)
		IDK.Size = UDim2.new(0, 40, 0, 40)
            ...
            function main:Toggle(text,config,callback)
                ...
                Toggle.MouseButton1Click:Connect(function()
                  ...
                  --      Image.Image = "rbxasset://"
                        ...
                        toggled = false
  				        ToggleImage2.Size = UDim2.new(0,0 , 0, 0)
                        ToggleImageCorner.CornerRadius = UDim.new(0, 5)
                       ToggleImage2.Visible = false
                    end
                    callback(toggled)
...
--[[
		function main:Dropdown(text,option,callback)
			...
			function main:MultiDropdown(Name, list, default, callback)
				local Dropfunc = {}
				...
				v.Name = "v"
				v.Parent = MainDropDown_2
				v.BackgroundColor3 = Color3.fromRGB(225, 225, 225)
				v.BackgroundTransparency = 1.000
				v.BorderSizePixel = 0
				v.Size = UDim2.new(1, 0, 1, 0)
				v.ZIndex = 16
				...
				Text_2.Name = "Text"
				Text_2.Parent = MainDropDown_2
				Text_2.BackgroundColor3 = Color3.fromRGB(225, 225, 225)
				Text_2.BackgroundTransparency = 1.000
				Text_2.Position = UDim2.new(0, 11, 0, 9)
				Text_2.Size = UDim2.new(0, 62, 0, 12)
				Text_2.ZIndex = 16
				Text_2.Font = Enum.Font.GothamBold
				Text_2.Text = getpro().." :"
				Text_2.TextColor3 = Color3.fromRGB(225, 225, 225)
				...
				Scroll_Items.Parent = MainDropDown
				Scroll_Items.Active = true
				Scroll_Items.BackgroundColor3 = Color3.fromRGB(10, 9, 9)
				Scroll_Items.BackgroundTransparency = 1.000
				Scroll_Items.BorderSizePixel = 0
				Scroll_Items.Position = UDim2.new(0, 0, 0, 35)
				Scroll_Items.Size = UDim2.new(1, 0, 1, -35)
						...
						function()
							if not table.find(DropTable, Text) then
								...
								TweenService:Create(
									_5,
									TweenInfo.new(.2, Enum.EasingStyle.Quad, Enum.EasingDirection.Out),
									{TextColor3 = Color3.fromRGB(127, 131, 137)}
								):Play()
							else
								TweenService:Create(
									_5,
...
--]]
		...
		function main:Textbox(text,disappear,callback)
            ...
            Main_U9.Color = Color3.fromRGB(255,0,0)
